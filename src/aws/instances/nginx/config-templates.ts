...
// # Function to set up the SSL-enabled API server block
// setup_api_ssl() {
//   if [ -d "/etc/letsencrypt/live/${serverName}" ]; then
//     echo "Setting up SSL-enabled API server on port 8032..."
...
// # Create the setup_api_ssl function - THIS FUNCTION IS EXPLICITLY DEFINED HERE
// # This function will be available to both this script and the SSL setup script
// # We need to escape the special characters since this is inside a template string
// cat > /usr/local/bin/setup_api_ssl.sh <<'SETUP_API_SSL_SCRIPT'
// #!/bin/bash
